...
export default function Capsule2({ onComplete, onProgress }) {
    ...
    return (<>
        <div className="w-full mx-auto rounded-xl border bg-card text-card-foreground shadow-sm flex flex-1 flex-col h-full overflow-hidden relative">
            ...
            {/* Button bar. */}
            <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-6 pt-12 sm:pt-16 bg-gradient-to-t from-card via-card to-transparent shrink-0 flex gap-3 sm:justify-end pointer-events-none">
                ...
                <div className="flex gap-3 sm:gap-4 flex-1 sm:flex-none w-full sm:w-auto pointer-events-auto">
                    ...
                    >
                        {isNextDisabled && (
                            <div className="absolute bottom-full left-1/2 sm:left-0 -translate-eft-0 -translate-x-1/2 mb-2 hidden group-hover:flex group-focus:flex group-active:flex flex-row justify-center items-center px-[12px] py-[6px] gap-[8px] isolate w-[201px] max-w-[384px] h-[44px] bg-[#171717] rounded-[8px] text-white text-xs text-center z-50 pointer-events-none shadow-lg">
